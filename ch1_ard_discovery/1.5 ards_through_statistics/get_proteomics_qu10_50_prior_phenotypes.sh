...
--phenotype_dnanexus_file ~/data/external/proteomics/proteomics_phenotype_file_off_dnanexus.csv \
--phenotype_covariate_file ~/data/internal/proteomics/proteomics_pan_ukbb_eur_covars.csv \
--export_eids_filtered n \
--phenotype_set pan_ukbb_eur_qu10_50_disease_fields.txt \
--phenotype_time prior \
-o ~/data/internal/proteomics/proteomics_pan_ukbb_eur_qu10_50_prior_phenotypes.csv
