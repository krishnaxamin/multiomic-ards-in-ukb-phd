""" Obtain per-disease age-of-onset profile and related data for the proteomics cohort. """
...
""" Export common and unisex disease fields in the proteomics cohort (everyone, by sex, by ancestry group) """
...
common_unisex_diseases.to_csv('~/data/internal/proteomics/proteomics_pan_ukbb_eur_common_unisex_disease_date_fields.csv', index=False)
...
for key in per_disease_age_of_onset_info.keys():
    ...
    for disease in specific_disease_df_dict.keys():
        ...
        export_path_dir = '~/data/internal/proteomics/proteomics_pan_ukbb_eur_time_series/common_unisex_' + key.lower()
