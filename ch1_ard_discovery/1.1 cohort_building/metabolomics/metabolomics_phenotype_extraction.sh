#!bin/bash
# Download all disease phenotype data for the metabolomics cohort
...
-ioutput=metabolomics_phenotypes_off_dnanexus \
-y --instance-type mem3_ssd1_v2_x8 --priority low --name metabolomics_phenotype_extraction