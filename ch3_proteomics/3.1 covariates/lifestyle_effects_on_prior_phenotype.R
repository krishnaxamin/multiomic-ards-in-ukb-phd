' Getting lifestyle effects on proteomics prior phenotypes, using logistic regression '
...
if (var(phenotype[disease]) != 0){
  ...
  write_csv(phenotype_vars_explained, paste0('~/ch3_proteomics/3.1 covariates/lifestyle_effects/on_prior_phenotype/', disease, '_lifestyle_effects_on_phenotype.csv'))
}
