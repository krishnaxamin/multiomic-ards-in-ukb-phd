"""
Regress out certain  factors from the proteomics data.
Assess the effect each regression has on variance explained by the factors.
"""
...
# covars to regress out: well; date at centre; plate; plate column; plate row; non-oily fish; beef; lamb; water
participant_covariates_of_interest = ['p53_i0', 'p30901_i0', 'p30902_i0', 'plate_row', 'plate_column',
                                      'p1339_i0', 'p1369_i0', 'p1379_i0', 'p1528_i0']
participant_covariates = participant_covariates[['eid'] + participant_covariates_of_interest].copy()
...
covariate_info = [{'field': 'p30901_i0', 'name': 'Plate', 'type': 'categorical'},
                  ...
                  {'field': 'p30902_i0', 'name': 'Well', 'type': 'categorical'},
...
# water - step 11
step11_var_explained_before, final_residuals, step11_var_explained_after = regress_out(covariate_df=all_covars,
                                                                                       data_df=step10_residuals,
                                                                                       covariate='p1528_i0',
                                                                                       protein=protein)
...
final_residuals.to_csv('regressing_out/post_regression_protein_data/' + protein + '.csv', index=False)
vars_explained_by_all_covars_at_each_step.to_csv(
    'regressing_out/effects/' + protein + '_effects_during_regressions.csv',
    index=False)
