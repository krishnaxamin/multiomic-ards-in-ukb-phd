' Getting covariate effects on metabolomics data, using linear regression '
...
write_csv(metabolite_vars_explained, paste0('technical_effects/on_metabolites/', metabolite, '_technical_effects_on_metabolites.csv'))
