' Getting lifestyle effects on metabolomics prior phenotypes, using logistic regression '
...
write_csv(phenotype_vars_explained, paste0('lifestyle_effects/on_prior_phenotype/', disease, '_lifestyle_effects_on_phenotype.csv'))
