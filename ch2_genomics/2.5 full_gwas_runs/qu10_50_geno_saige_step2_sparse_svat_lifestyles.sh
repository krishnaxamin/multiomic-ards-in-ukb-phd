...
#$ -l h_vmem=30G
#$ -j y
#$ -N qu10_50_geno_sparse_svat_lifestyles
#$ -o /data/scratch/bty207/saige_sparse_svat_lifestyles/qu10_50_geno_svat_logs/
#$ -t 1-68
...
--SAIGEOutputFile="~/ch2_genomics/2.5 full_gwas_runs/step2_svat_lifestyles/${disease}/${disease}_pan-ukbb-eur.geno.svat" \
