...
#$ -l h_vmem=60G
#$ -j y
#$ -N qu10_50_saige_var_estimate
#$ -o /data/scratch/bty207/saige_var_estimate/qu10_50_logs/
#$ -t 1-68
...
--phenoCol=${disease} \
--traitType=binary \
--covarColList=p21003_i0,p31,p54_i0,p22000,p22008,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10,PC11,PC12,PC13,PC14,PC15,PC16,PC17,PC18,PC19,PC20 \
--qCovarColList=p31,p54_i0,p22000,p22008 \
--sampleIDColinphenoFile=IID \
--minMAFforGRM=0 \
--maxMissingRateforGRM=1 \
--nThreads=$NSLOTS \
--includeNonautoMarkersforVarRatio=TRUE \
--outputPrefix="~/ch2_genomics/2.5 full_gwas_runs/step1_var_estimate/${disease}" \
