# STEP 5: run LAVA (potential to array by locus if takes a long time)
...
loci <- read.loci('~/ch2_genomics/2.11 local_genetic_correlations/int_data/loci_ld_blocks_only.txt')
